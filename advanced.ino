...
const char* motivationMessages[] = {
  ...
  "Today's Pain Is@Tomorrow's IIT",
  "Only 100 Days Left@Make Each Count",
  "Wake Up At 5 AM@Slay The GATE Exam",
  "Just One More Hour@Changes Everything",
  "Take A Mock Test@Analyze Mistakes",
  "Your Weak Subject@Attack It First",
  "PYQ Papers Are@Pure Gold For GATE",
  "Revision Is Not@Optional, It's Key",
  "Sleep Only 6 Hours@Score Will Rise",
  "Your Competition@Is Studying Now",
  "Comfort Zone Is@Dangerous For You",
  "No Zero Days Allowed@Do Something Daily",
  "Small Steps Lead@To Big Results",
  "Consistency Beats@Raw Intelligence",
  "Stop Scrolling Now@Start Solving Problems",
  "Put Your Phone Down@Score Goes Up",
  "One Problem At A Time@With Full Focus",
  "Short Break Then@Back To Hard Work",
  "Make Your Parents@Proud With Your Rank",
  "Your Future Self@Will Thank You Today",
  "IIT Is Not A Dream@It's A Goal Now",
  "Rank Under 100@Is Achievable For You",
  "Top 50 Rank@Should Be Your Target",
  "AIR 1 Is Someone's@Make It Yours",
  "Every Single Hour@Counts In GATE Prep",
  "Your Rival Never@Takes A Day Off",
  "The Pain You Feel@Will Be Your Power",
  "Success Doesn't Come@To Those Who Wait",
  "Make Sacrifices Now@Enjoy Results Later",
  "Your Hard Work@Speaks Through Your Rank",
  "Don't Let Small@Distractions Win",
  "Stay Hungry For@Knowledge Always",
  "Stay Foolish For@Timepass Activities",
  "The IIT Tag@Changes Your Entire Life",
  "One Year Of Pain@For 40 Years Of Gain",
  "Short Term Pain@Long Term Unlimited Gain",
  "Your Future IIT@Life Is Waiting For You",
  "Don't Look Back@Wrong Direction Only",
  "Keep Your Eyes@On The IIT Prize",
  "Today's Struggle@Builds Your Character",
  "IIT Bombay Waits@For Top Rankers",
  "IIT Delhi Gates@Open For Toppers",
  "IIT Madras Campus@Is Calling You Now",
  "IIT Kanpur Needs@Your Hard Work",
  "IIT Kharagpur@The First IIT Awaits",
  "IIT Roorkee Legacy@Needs Your Name",
  "IIT Guwahati Beauty@Awaits Your Steps",
  "IIT Hyderabad Is@Ready For Your Rank",
  "IIT Indore Wants@Bright Minds Like You",
  "IIT BHU Is Calling@Future Technocrats",
  "IIT Gandhinagar@Welcomes Hard Workers",
  "IIT Ropar Labs@Need Your Experiments",
  "IIT Patna Is@Building Future Leaders",
  "IIT Bhubaneswar@Awaits Your Genius",
  "IIT Mandi Hills@Need Your Presence",
  "IIT Jodhpur Is@Ready For Innovators",
  "IIT Palakkad@Welcomes Determined Souls",
  "IIT Tirupati@Looks For Top Talent",
  "IISc Bangalore@The Ultimate Dream",
  "IIT ISM Dhanbad@Mining Your Future",
  "Aptitude Is Easy@Just Practice More",
  "Mathematics Scoring@Master The Basics Well",
  "Probability Has@High Weightage In GATE",
  "Linear Algebra@Makes Big Difference",
  "Calculus Needs@Daily Practice Now",
  "Discrete Math@Is A Game Changer",
  "Graph Theory@Comes Every Year",
  "TOC Questions@Are High Scoring",
  "Compiler Design@Tricky But Scoring",
  "Compiler Design@Practice More Now",
  "Operating System@Is Core For GATE CS",
  "Deadlock Semaphore@Must Do Topics",
  "Computer Networks@Memorize Layering Well",
  "TCP IP Stack Is@Important For Exam",
  "DBMS SQL Queries@Practice Them Daily",
  "Normalization Is@High Weightage Topic",
  "Data Structures@Backbone Of CS",
  "Algorithms Make@You Think Deeply",
  "Time Complexity@Master It First",
  "Recursion Tree@Practice It Daily",
  "DP Problems Solve@5 Problems Daily",
  "Greedy Works For@Many Problems Easily",
  "Graph Algorithms@Must Do For GATE",
  "Tree Traversal Is@Easy Marks Topic",
  "Sorting Networks@Revise Before Exam",
  "Searching Algos@Come Every Year",
  "Hashing Techniques@Important Subject",
  "Heap Operations@Easy Scoring Zone",
  "Stack And Queue@Basic But Important",
  "Linked Lists@Concepts Must Clear",
  "Binary Trees@Traversal Is Key",
  "AVL Rotations@Practice Makes Perfect",
  "B Trees B+ Trees@Important For DBMS",
  "Dynamic Programming@Practice More Problems",
  "Divide And Conquer@Master Recurrences",
  "Morning 6 AM Is@Your Study Time",
  "First 2 Hours Are@Most Productive",
  "Pomodoro 25 Mins@Work Then 5 Break",
  "Study For 2 Hours@Break 10 Minutes",
  "Night Revision@Solidifies Memory",
  "Weekly Mock Test@Check Your Progress",
  "Analyze Mistakes@Improve Rapidly",
  "Time Bound Practice@For Questions",
  "Speed Matters A Lot@In The Real Exam",
  "Accuracy First Then@Work On Your Speed",
  "Leave Hard Questions@Solve Easy First",
  "Mark For Review And@Come Back Later",
  "Don't Overthink On@One Single Question",
  "Move On Fast Because@Time Is Limited",
  "First Attempt What@You Know Very Well",
  "Read The Question@Carefully Twice",
  "Eliminate Options@Increase Probability",
  "Guess Only Smartly@When You Are Confident",
  "Don't Waste Time@On One Question",
  "Negative Marking@Is Very Dangerous",
  "Attempt What You@Know Very Well",
  "Numerical Questions@Solve Them First",
  "Theory Questions@Read Options Well",
  "MSQ Questions Are@Tricky Be Careful",
  "NAT Questions Have@No Negative Marking",
  "Attempt All NAT@If Time Is Left",
  "MCQ First Then@Go For MSQ Next",
  "Don't Change Answers@Without Good Reason",
  "First Instinct Is@Often The Correct One",
  "Use Rough Sheet@Properly For Working",
  "Feeling Nervous Is@Normal Just Breathe",
  "Exam Pressure@Makes You Stronger",
  "Fear Of Failure@Is Your Best Fuel",
  "One Bad Mock Test@Doesn't Define You",
  "Learn Something From@Every Single Mistake",
  "The Last Month@Makes The Difference",
  "Final Revision Is@Crucial For Success",
  "Trust Your Prep You@Are Ready For This",
  "Confidence Is Half@The Battle Won",
  "Stay Calm During@The Whole Exam",
  "Don't Compare With@Other Students",
  "Your Journey Is@Unique To You Only",
  "Mental Health Matters@For Your Success",
  "Take Deep Breaths@Before Starting Exam",
  "Positive Self Talk@Every Single Morning",
  "Others Will Celebrate@Without You There",
  "Your Ex Is Watching@Your Failure Closely",
  "Neighbors Will Judge@Your Exam Results",
  "Facebook Friends@Don't Care About You",
  "Instagram Reels@Waste Your Precious Time",
  "Your Competition@Is Sleeping Less Than You",
  "They Are Already@Ahead Catch Up Fast",
  "Your Batchmates Will@Get IIT Seats",
  "Will You Be The@One Left Behind?",
  "Parents Silence Hurts@More Than Scolding",
  "Relatives Will Ask@Beta Kitna Laya?",
  "Your Name Not In@The Top 100 List",
  "Someone Else Will@Take Your IIT Seat",
  "You Will Watch Others@At IIT Bombay",
  "Your Dream Will@Remain A Dream Only",
  ...
  "Don't Be The Why@Not You Story",
  "Every Skip Is A@Step Towards Failure",
  "Comfort Today Means@Regret Tomorrow",
  "Your Rival Is@Solving PYQs Right Now",
  "You Are Losing Your@IIT Seat Daily",
  "The Clock Never@Stops For Anyone",
  "Time Wasted Is@Never Coming Back",
  "Opportunity Knocks@Only Once In Life",
  "IIT Seat Count Is@Very Limited",
  "10 Lakh Students@Fighting For 1000 Seats",
  "Be In Top 0.1%@Or Become Nobody",
  "I Can Solve This@Question Right Now",
  "I Am Getting Better@Every Single Day",
  "I Will Definitely@Crack GATE 2027",
  "IIT Is My Final@Destination For Sure",
  "I Am A Future@IITian Without Doubt",
  "My Hard Work Will@Pay Off Very Soon",
  "I Deserve That@Top Rank Indeed",
  "Success Is My@Only Option Now",
  "I Am Capable Of@Achieving Greatness",
  "My Potential Is@Limitless Always",
  "I Control My Focus@And My Effort",
  "Every Day I Improve@A Little Bit More",
  "I Am Stronger Than@My Own Excuses",
  "My Dreams Are Worth@The Sacrifice",
  "I Choose To Win@This Battle Now",
  "Revise Your Formula@Sheets Every Day",
  "Short Notes Are@Your Best Weapon",
  "Solve Previous Papers@In Time Limit",
  "Take A Full Mock@Every Sunday",
  "Analyze Your Weak@Areas And Fix Them",
  "Stop New Topics Now@Revise Old Ones Well",
  "Sleep Very Well@Before The Exam Day",
  "Reach The Center@1 Hour Early Morning",
  "Carry Your Admit@Card And ID Proof",
  "Stay Hydrated But@Don't Overdrink Water",
  "Eat Light Before@Exam For Better Focus",
  "Use Restroom Before@Entering The Hall",
  "Keep Extra Pens@And Pencil With You",
  "Don't Panic If You@See A Hard Paper",
  "Everyone Finds The@GATE Paper Tough",
  "You Have Prepared@Now Just Perform Well",
  "Trust Yourself You@Got This For Sure",
  "Stay Positive And@Stay Focused Now",
  "One Question At A@Time Take It Slowly",
  "Don't Panic Just@Read Questions Carefully",
  "Use The Rough Sheet@Properly For Working",
  "Check Your Answers@If Time Is Left",
  "Don't Discuss After@Exam With Your Friends",
  "Next Paper Focus@On It Completely Now",
  "You Will 100%@Make It This Time",
  "Today Is Your Day@To Shine Very Bright",
  "All Your Hard Work@Pays Off Today",
  "Stay Confident You@Are Well Prepared",
  "Breathe Deep And@Then Start The Exam",
  "Victory Is Waiting@For You Right Now",
  "No Pain Equals@No IIT Tag Ever",
  "Grind Very Hard@Then Shine Like A Star",
  "Stay Super Focused@To Stay Far Ahead",
  "Do It Right Now@Procrastination Kills Dreams",
  "You Definitely Can@And You Surely Will",
  "Never Ever Give Up@On Your IIT Dream",
  "Almost There Now@Keep Going Faster",
  "Final Stretch Time@Give Your Absolute Best",
  "Last Lap Remaining@Sprint To The Finish",
  "Finish Very Strong@Top Rank Awaits You",
  "Wake Up Early And@Conquer The Whole Day",
  "Sleep When Tired@But Never Quit Your Dream",
  "Push Your Limits@Beyond What You Think",
  "Break Your Records@Every Single Week",
  "Be Unstoppable And@Unbeatable Always",
  "Crush Your Goals@One By One Daily",
  "Dominate The Exam@With Your Preparation",
  "Rule The Rank List@And Be The Topper",
  "Own Your Success@Nobody Will Give You",
  "Claim Your IIT Seat@With Your Hard Work",
  "Earn Your Respect@Through Your Rank",
  "Build Your Legacy@Starting From Today",
  "Create Your Story@Of GATE Success",
  "Write Your Name In@IIT History Books",
  "Become The Legend@Your Parents Dream Of"
};
...
void setup() {
  ...
  lcd.setCursor(0, 0); lcd.print("GATE GUARDIAN");
  lcd.setCursor(3, 1); lcd.print("MADE BY RAHUL");
  delay(1800);
  lcd.clear();
}
